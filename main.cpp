...
int ID = 1;
extern void splitCSVLine(const std::string& line, std::string* fields, int maxFields);
extern void splitLine(const std::string& line, std::string* fields, int maxFields);
